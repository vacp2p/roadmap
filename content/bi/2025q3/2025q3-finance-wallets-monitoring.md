...
`vac:bi:ift:2025q3-finance-wallets-monitoring`
...
* fully qualified name: `vac:bi:ift:2025q3-finance-wallets-extractions`
* owner: apentori
* status: done
...
* fully qualified name: `vac:bi:ift:2025q3-finance-wallets-visualization`
* owner: 
