...
#### Deliverables
- [vacp2p/nim-lsquic#103](https://github.com/vacp2p/nim-lsquic/pull/103) feat(transport): support per-dial certificate verification
...
#### Deliverables
- [vacp2p/nim-libp2p#2880](https://github.com/vacp2p/nim-libp2p/pull/2880) feat(quic): validate expected peer id during dial
