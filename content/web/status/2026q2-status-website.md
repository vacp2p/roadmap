...
- **Global Accessibility**: Expanding internationalization support to reach broader global audiences
- **Discoverability**: Improving SEO to increase organic traffic and user acquisition
...
- [status-im/status-web#1210](https://github.com/status-im/status-web/pull/1210) Update get.status.app and request domain
